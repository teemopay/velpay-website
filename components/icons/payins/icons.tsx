    ...
    >
      <g id="web3" clipPath="url(#clip0_4362_23934)">
        <g id="Group">
          ...
          >
            <div
              style={{
                ...
                clipPath: "url(#bgblur_1_4362_23934_clip_path)",
                height: "100%",
                width: "100%",
              }}
            />
          ...
          <g
            id="detail"
            filter="url(#filter0_i_4362_23934)"
            data-figma-bg-blur-radius="50.9527"
          >
            <path
              d="M17.7656 26.6484C21.0361 26.6484 23.6874 23.9971 23.6874 20.7265C23.6874 17.456 21.0361 14.8047 17.7656 14.8047C14.4951 14.8047 11.8438 17.456 11.8438 20.7265C11.8438 23.9971 14.4951 26.6484 17.7656 26.6484Z"
              fill="white"
              fillOpacity="0.16"
            />
            <path
              d="M38.4921 26.6484C41.7627 26.6484 44.4139 23.9971 44.4139 20.7265C44.4139 17.456 41.7627 14.8047 38.4921 14.8047C35.2214 14.8047 32.5702 17.456 32.5702 20.7265C32.5702 23.9971 35.2214 26.6484 38.4921 26.6484Z"
              fill="white"
              fillOpacity="0.16"
            />
            <path
              d="M17.7656 19.0508C18.6911 19.0508 19.4414 19.8011 19.4414 20.7266C19.4414 21.6521 18.6911 22.4023 17.7656 22.4023C16.8401 22.4023 16.0899 21.6521 16.0898 20.7266C16.0898 19.801 16.8401 19.0508 17.7656 19.0508ZM38.4922 19.0508C39.4177 19.0508 40.168 19.801 40.168 20.7266C40.168 21.6521 39.4177 22.4023 38.4922 22.4023C37.5666 22.4023 36.8164 21.6521 36.8164 20.7266C36.8164 19.801 37.5666 19.0508 38.4922 19.0508Z"
              stroke="#6C6D6C"
              strokeWidth="8.49212"
            />
          </g>
